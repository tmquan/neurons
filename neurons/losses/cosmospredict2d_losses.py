"""
Cosmos-Predict2.5 **2D** combined loss for image segmentation.
...
class CosmosPredict2DLoss(nn.Module):
    """Composite loss for Cosmos-Predict2.5 2D segmentation heads.
