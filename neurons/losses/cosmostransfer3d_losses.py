"""
Cosmos-Transfer2.5 **3D** combined loss for volumetric segmentation.
...
class CosmosTransfer3DLoss(nn.Module):
    """Composite loss for Cosmos-Transfer2.5 3D volumetric segmentation heads.
