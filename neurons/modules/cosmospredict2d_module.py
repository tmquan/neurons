"""
Cosmos-Predict2.5 **2D** Lightning Module for image segmentation training.
...
from neurons.models.cosmospredict2d_model import (
    CosmosPredict2DWrapper as _Model,
    verify_fit,
)
from neurons.losses.cosmospredict2d_losses import CosmosPredict2DLoss as _Loss
...
class CosmosPredict2DModule(pl.LightningModule):
    """PyTorch Lightning module for 2-D Cosmos-Predict2.5 segmentation.
    ...
    Args:
        model_config: Forwarded to :class:`CosmosPredict2DWrapper`.
        optimizer_config: Optimizer / scheduler settings.
        loss_config: Forwarded to :class:`CosmosPredict2DLoss`.
