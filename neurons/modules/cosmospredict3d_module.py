...
from neurons.models.cosmospredict3d_model import (
    CosmosPredict3DWrapper as _Model,
    verify_fit,
)
from neurons.losses.cosmospredict3d_losses import CosmosPredict3DLoss as _Loss
...
class CosmosPredict3DModule(pl.LightningModule):
